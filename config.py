...
SQLALCHEMY_DATABASE_URI = 'mysql+pymysql://root:123asd@localhost:3306/TestDB?charset=utf8'
#SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://dbuser:123asd@localhost/bi_sys'
